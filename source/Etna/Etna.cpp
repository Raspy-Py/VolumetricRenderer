...
static Etna::Application* s_Application = nullptr;
...
void Etna::Init(int argc, char **argv)
{
    // Init vulkan
    ...
    g_Window = glfwCreateWindow(1280, 720, "Dear ImGui GLFW+Vulkan example", nullptr, nullptr);
